...
namespace NuciLog.Core.UnitTests
{
    public sealed class LoggerTests4Warn
    {
        ...
        [Test]
        public void Warn_Message_LogsCorrectly()
        {
        ...
        [Test]
        public void Warn_MessageAndNullExtraLogInfos_LogsCorrectly()
        {
            string message = "testudo";
        ...
        [Test]
        public void Warn_MessageAndNullLogInfos_LogsCorrectly()
        {
            string message = "testudo";
        ...
        [Test]
        public void Warn_MessageAndNullLogInfosAndNullExtraLogInfos_LogsCorrectly()
        {
            string message = "testudo";
